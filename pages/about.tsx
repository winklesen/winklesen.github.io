...
export const connectLinks = [
  { label: "Email", href: "mailto:winklesenkraft@me.com" },
  { label: "Twitter", href: "https://twitter.com/winklesenkraft" },
  { label: "GitHub", href: "https://github.com/winklesenkraft" },
];
...
const sideProjects = [
  {
    ...
    link: "https://github.com/winklesenkraft/routes",
  },
  {
    title: "notion-blog-nextjs",
    description: "Next.js starter repo with a blog powered by Notion",
    imageSrc: notionLogo,
    link: "https://github.com/winklesenkraft/notion-blog-nextjs",
  },
  {
    title: "Strength",
    description: "iOS & WatchOS strength tracking app",
    imageSrc: strengthLogo,
    link: "https://winklesenkraft.github.io/strength/",
  },
  {
    title: "winklesenkraft-next",
    description: "The website you are looking at!",
    imageSrc: avatar,
    link: "https://github.com/winklesenkraft/winklesenkraft-next",
  },
];

const seoTitle = "About | winklesen Kraft";
const seoDesc =
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: seoTitle,
          description: seoDesc,
          url: `https://winklesenkraft.com/about/`,
        ...
        >
          <Section heading="About me" headingAlignment="right">
            <div className="flex flex-col gap-6">
              <p>
                <em className="font-semibold">Hi there!</em>&nbsp; I’m winklesen, a
