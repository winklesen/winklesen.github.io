...
You can find the full source code [here](https://github.com/winklesenkraft/winklesenkraft-next/blob/master/components/blog/rating.tsx). Let me know if you found this CSS tip useful by pressing the heart below 👇