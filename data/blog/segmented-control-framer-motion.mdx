...
The full source code is [available on my GitHub](https://github.com/winklesenkraft/winklesenkraft-next/blob/master/components/segmentedcontrol.tsx).
...
If this helped press the ❤️ below or let me know on [Twitter](https://twitter.com/winklesenkraft)
