...
Our route data is in the form of a geoJson object. Check out my article [Building a mapping platform with React and Mapbox GL](https://winklesenkraft.com/blog/trailroutes) for details how to parse geoJson from gpx files.
...
That's it! Find the full source code [here](https://github.com/winklesenkraft/routes/blob/master/scripts/generate-images.js) and check out a few examples of images I generated:
