...
Voila! We now have a smooth working animation, perfect for building a music widget like the one on this website or similar! Check out the [full source code on GitHub](https://github.com/winklesenkraft/winklesenkraft-next/blob/master/components/nowplaying.module.scss).
