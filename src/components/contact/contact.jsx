  ...
  const sosmeds = [
    {
      ...
      link: "https://www.tiktok.com/@winklesen",
    },
    {
      name: "Github",
    ...
    },
    {
      ...
      link: "https://www.instagram.com/wnklsn/",
    },
    {
      name: "Telegram",
      icon: <TbBrandTelegram size={20} />,
      link: "https://t.me/SamuelBernard",
    },
    {
      name: "Linkedin",
      icon: <FiLinkedin size={20} />,
      link: "https://id.linkedin.com/in/samuel-bernard-jeffersen",
    },
  ];
  return (
      ...
      <div className="fixed bottom-0 right-0 w-[105px]">
        <div className="flex flex-col items-center" data-aos="fade-up">
          <div data-aos="fade-left" data-aos-duration="600">
            <a
              href="mailto:samuelbjeffersen@gmail.com"
