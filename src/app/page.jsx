...
export const metadata = {
  title: "Samuel",
  description:
    "Samuel B. Jeffersen is a Mobile software engineer specializes in building (and sometimes designing) amazing and new digital experiences.",
};
    ...
    <div>
      <div className="flex h-[80vh] w-full flex-col justify-center px-0 pt-44 leading-relaxed md:h-screen md:pt-16 lg:px-[70px] lg:pt-12 ">
        ...
        <p
          ...
          data-aos="zoom-in-up"
        >
          I'm a Mobile Software Engineer with years of mobile app development
          experience, specializing in the Kotlin & Dart. I'm passionate about
        ...
        >
          <a
            ...
            href="https://drive.google.com/file/d/1L-zuc8fw2UziSq_kcEEkqgsQGYJnRzJM/view?usp=sharing"
            target="_blank"
            rel="noreferrer"
          >
      ...
      <div className="flex h-[650px] w-full flex-col items-center justify-center py-24 text-center ">
        ...
        <div className="z-40 mb-0 md:mb-10">
          ...
          >
            Delivering modern,
            <br />
            cohensive & instuitive app solution.
          </h2>
          <p
            ...
            data-aos-duration="300"
          >
            I enjoy developing meaningful experiences for brands & businesses to
